...
pdf('scatter-sliced-rev-with-empirical.pdf')
plot(dc$V3, dc$V5,
        type="p",
        pch=1,
        #axes=FALSE,
        ...
        cex=2)
points(dn$V3, dn$V5, pch=17, cex=2)
points(dg$V3, dg$V5, pch=19, cex=2)
points(dr$V3, dr$V5, pch=0, cex=2)
points(er$V3[1], er$V5[1], pch=2, cex=2)
points(er$V3[2], er$V5[2], pch=3, cex=2)
points(er$V3[3], er$V5[3], pch=4, cex=2)
legend("topright",
        inset=0.01,
